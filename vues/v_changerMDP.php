...
<form method="post" action="index.php?uc=<?php echo $cible; ?>&num=check" id='chgMDP' class="formulaire" onsubmit="encodeMDPenMD5()" >
    <div class='formulaireLigneDesc'>               
        <?php
        if ("changerMdP" === $cible) {
            echo $_SESSION['pseudo'] . " saisissez votre ancien mot de passe puis deux fois le nouveau.";
        } else {
            ...
            echo "Pour le client ".$prenomClient." ".$nomClient.", saisissez deux fois le nouveau mot de passe. L'ancien sera écrasé.";
        }
        ?>
